 ...
 * @param map The map
 * @param moves The instructions list
 */
...
/**
 * Test if a point can be pushed up
 * @param map The map
 * @param point The point to push
 * @param depth Received the depth of the recursion
 * @return 1 if the point can be pushed, 0 otherwise
 */
int TestPushUp(const std::vector<std::vector<char>> & map, const std::pair<int,int> point, int & depth);
/**
 * Test if a point can be pushed down
 * @param map The map
 * @param point The point to push
 * @param depth Received the depth of the recursion
 * @return 1 if the point can be pushed, 0 otherwise
...
/**
 * Test if a point can be pushed right
 * @param map The map
 * @param point The point to push
 * @param depth Received the depth of the recursion
 * @return 1 if the point can be pushed, 0 otherwise
...
/**
 * Test if a point can be pushed left
 * @param map The map
 * @param point The point to push
 * @param depth Received the depth of the recursion
 * @return 1 if the point can be pushed, 0 otherwise
 ...
 * @param point The point to push
 * @param depth Received the depth of the recursion
 * @return 1 if the point was pushed, 0 otherwise
 */
