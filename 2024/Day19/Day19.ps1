...
$p | select-object -first 5 |% {
    $pp = $_
    "$n $pp" | Write-Warning
    $b = $a | Where-Object { $pp -match $_ } | Sort-Object Length -Descending
    $c = @('^((',$($b -join ')|('),'))+$') -join ''
    "$n $c" | Write-Warning
    if($_ -match $c) {
        [pscustomobject]@{$n = $pp}
...
$a | Sort-Object Length | Group-Object Length | Sort-Object Count -Descending | Select-Object -First 5 |% {
    $b = $_.Group | Sort-Object Length -Descending
    $c = @('^((',$($b -join ')|('),'))+$') -join ''
    if($p -match $c) {
        $p -replace $c, ''
    }
...
$colors = 'w','b','g','r','u'
$n = 1
$g = $a | Sort-Object Length -Descending | Group-Object Length | Select-Object -ExpandProperty Group |% {
    $pp = $_
    "$n $pp" | Write-Warning
    $b = $a | Where-Object { $pp -match $_ } | Sort-Object Length -Descending
    $c = @('^((',$($b -join ')|('),'))+$') -join ''
...
@{
    '1' = $a | Sort-Object Length | Group-Object Length |? {$_.Name -eq '1'} | Select-Object -ExpandProperty Group  | Sort-Object
    '2'$two_letter = $a | Sort-Object Length | Group-Object Length |? {$_.Name -eq '2'} | Select-Object -ExpandProperty Group  | Sort-Object
$three_letter = $a | Sort-Object Length | Group-Object Length |? {$_.Name -eq '3'} | Select-Object -ExpandProperty Group  | Sort-Object
$two_letter |? { -not ( "$($_[1])$($_[0])" -in $two_letter -and $_[0] -in $one_letter -and $_[1] -in $one_letter ) }